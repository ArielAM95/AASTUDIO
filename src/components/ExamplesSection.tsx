      ...
      <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <div className="relative z-10 p-8">
                  ...
                  <HoverPeek url={example.url} peekWidth={400} peekHeight={250}>
                    <a 
                      ...
                      className="inline-flex items-center gap-3 bg-custom-purple hover:bg-custom-purple/90 text-white font-medium px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105"
                    >
                      {example.linkText}
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-gray-200">
            ...
            <button className="text-custom-purple hover:text-custom-purple/80 font-semibold transition-colors">
              צרו קשר עכשיו →
            </button>
          </div>
        </div>
