  ...
  return <section className="py-16 px-4 bg-gray-50">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {examples.map((example, index) => <div key={index} className="rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow bg-inherit">
              ...
              <HoverPeek url={example.url} peekWidth={300} peekHeight={200}>
                <a href={example.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-custom-purple hover:text-opacity-80 font-medium underline decoration-dotted hover:decoration-solid transition-all">
                  {example.linkText}
