      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">אימייל: info@example.com</p>
            <div className="flex gap-4">
              <a
                href="https://wa.me/972545308505"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-green-600 hover:bg-green-700 h-10 w-10 rounded-full flex items-center justify-center transition-colors"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#3b5998] hover:bg-[#2d4473] h-10 w-10 rounded-full flex items-center justify-center transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#E4405F] hover:bg-[#d32d57] h-10 w-10 rounded-full flex items-center justify-center transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
