...
const HeroSection = () => {
  ...
  return (
    <>
      <NoiseDemo />
      <section className="hero-gradient py-16 md:py-24 px-4 rounded-b-3xl relative">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 animate-fade-in">
              <h1 className="text-3xl md:text-5xl font-bold text-custom-purple mb-6 font-rubik leading-tight">אנחנו נבנה לכם דף נחיתה או אתר לפי הצורך שלכם
    בימים בודדים ובלי לקרוע את הכיס
            </h1>
            ...
            animationDelay: "0.2s"
              ...
              <div className="relative">
                ...
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="אנשים עובדים על מחשב" className="rounded-2xl shadow-lg relative z-10 w-full" />
              </div>
            </div>
          </div>
        </div>
