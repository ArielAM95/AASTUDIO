...
const ServicesSection = () => {
  ...
  return <section className="py-16 px-4" id="services">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-center mt-8 text-gray-600 font-assistant">* המחירים וזמן האספקה תלויים באפיון צרכי הלקוח
* המחירים לא כוללים מע"מ</p>
      </div>
    </section>;
};
